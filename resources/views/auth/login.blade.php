...
<body>
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <form class="form" method="post" action="{{ route('login') }}">
                                @method('POST')
                                @csrf
                                <div class="form-group{{ $errors->has('nomor_induk') ? ' has-danger' : '' }}">
                                    <label>Nomor Induk <span class="login-danger">*</span></label>
                                    <input type="number" name="nomor_induk"
                                        class="form-control{{ $errors->has('nomor_induk') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('Nomor Induk') }}" value="{{ old('nomor_induk') }}">
                                    @include('alerts.feedback', ['field' => 'nomor_induk'])
    ...
    @endif
    <script src="{{ asset('assets/js/jquery-3.7.1.min.js') }}" type="5efc1e919af88a7fde8118da-text/javascript"></script>

    <script src="{{ asset('assets/js/bootstrap.bundle.min.js') }}" type="5efc1e919af88a7fde8118da-text/javascript"></script>

    <script src="{{ asset('assets/js/feather.min.js') }}" type="5efc1e919af88a7fde8118da-text/javascript"></script>

    <script src="{{ asset('assets/js/script.js') }}" type="5efc1e919af88a7fde8118da-text/javascript"></script>
    <script src="{{ asset('cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}"
        data-cf-settings="5efc1e919af88a7fde8118da-|49" defer></script>
</body>
