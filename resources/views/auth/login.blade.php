                ...
                <div class="card-body">
                    <form class="form" method="post" action="{{ route('login') }}">
                        ...
                        <div class="mb-3 {{ $errors->has('nisn') ? ' has-danger' : '' }}">
                            <input type="number" class="form-control {{ $errors->has('nisn') ? ' has-danger' : '' }}" placeholder="NISN" aria-label="NISN" value="{{ old('nisn') }}">
                            @include('alerts.feedback', ['field' => 'nisn'])
                        </div>
                        <div class="mb-3 {{ $errors->has('password') ? ' has-danger' : '' }}">
                            <input type="number" class="form-control {{ $errors->has('password') ? ' has-danger' : '' }}" placeholder="Password" aria-label="Password" value="{{ old('password') }}">
                            @include('alerts.feedback', ['field' => 'password'])
                        </div>
