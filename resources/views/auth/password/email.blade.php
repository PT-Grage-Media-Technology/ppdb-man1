...
<head>
    ...
    <title>EduPotensi - Forgot Password</title>
...
<body>
                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <p class="account-subtitle">Kami akan mengirimkan email untuk mereset kata sandi anda!</p>

                            <form action="{{ route('password.email') }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label>Masukkan email address terdaftar <span class="login-danger">*</span></label>
    ...
    <script src="/assets/js/jquery-3.7.1.min.js" type="9103fadcbcb3d0b00cf05211-text/javascript"></script>

    <script src="/assets/js/bootstrap.bundle.min.js" type="9103fadcbcb3d0b00cf05211-text/javascript"></script>

    <script src="'/assets/js/feather.min.js" type="9103fadcbcb3d0b00cf05211-text/javascript"></script>

    <script src="'/assets/js/script.js" type="9103fadcbcb3d0b00cf05211-text/javascript"></script>
    <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="9103fadcbcb3d0b00cf05211-|49" defer></script>
</body>
